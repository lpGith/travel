...
<div class="insurance panel mt20" id="insurance_box">
    ...
    <div class="panel_body">
        ...
        <li class="list_header">
            <span class="col2" style="padding-left:25px;width:70%;font-size:20px;color:blue;">景点名：{{session("list")->list_name}}</span>
            <span class="col5" style="width:15%;font-size:20px;color:red;">{{session("model")->pay_total}}.00元</span>
        </li>
		<li class="list_row ">
			<span class="col2" style="padding-left:25px;width:100%;">景点地址：{{session("list")->list_address}}</span> 
		</li> 
		...
		<li class="list_row hide baoxian_detail"  style="display: none;">
			<span class="col2" style="padding-left:25px;width:100%;">票种：{{session("list")->list_piaozhong}}</span> 
		</li>
		<li class="list_row hide baoxian_detail"  style="display: none;">
			<span class="col2" style="padding-left:25px;width:100%;">票数：{{session("model")->pay_num}}</span> 
		</li>
		<li class="list_row hide baoxian_detail"  style="display: none;">
...
<div class="insurance panel mt25" id="contact_box">
    ...
    <div class="panel_body">
	    <ul class="list">
			...
			<li class="list_row hide myprice mt15"   style="display: block;">
				<button  style="width:100px;margin-left:25px;"><span class="col2" style="padding-left:25px;">
				   <a id="dopay_id" onclick="return dosubmit();" href="/goupiaomail?id={{session('list')->id}}&uid={{session('model')->id}}">确认支付</a></span></button>
			</li>
			<!--  end -->
		 </ul>
		 <!--  支付宝 -->
