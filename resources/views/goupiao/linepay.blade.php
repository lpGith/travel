...
<div class="insurance panel mt20" id="insurance_box">
    ...
    <div class="panel_body">
        ...
        <li class="list_header">
            <span class="col2" style="padding-left:25px;width:70%;font-size:20px;color:blue;">团游名：{{session('list')->tuangou_name}}</span>
            <span class="col5" style="width:15%;font-size:20px;color:red;">{{session('model')->pay_total}}.00元</span>
        </li>
		<li class="list_row ">
			<span class="col2" style="padding-left:25px;width:100%;">游览地址：{{session('list')->tuangou_chufa}}-->{{session('list')->tuangou_mudi}}</span> 
		</li> 
		...
		<li class="list_row hide baoxian_detail"  style="display: none;">
			<span class="col2" style="padding-left:25px;width:100%;">成人数：{{session('model')->pay_num}}</span> 
		</li>
		<li class="list_row hide baoxian_detail"  style="display: none;">
			<span class="col2" style="padding-left:25px;width:100%;">儿童数：{{session('model')->pay_num1}}</span> 
		</li>
		<li class="list_row hide baoxian_detail"  style="display: none;">
    ...
    <div class="panel_body">
	    <ul class="list">
			...
			<li class="list_row hide myprice mt15"   style="display: block;">
				...
				<input class="kong upass" info="密码" type="password" name="upass" onblur="checkupass()" style="height:30px;border:1px solid black;" placeholder="请输入您的密码" value=""/>
				</form>
				</span> 				
			</li>
			...
			<li class="list_row hide myprice mt15"   style="display: block;">
				<button id="dopay_id" style="width:100px;margin-left:25px;"><span class="col2" style="padding-left:25px;"><a id="dopay_id" onclick="return dosubmit();" href="/goupiaolinemail?id={{session('list')->id}}&uid={{session('model')->id}}">确认支付</a></span></button> 
			</li>
			<!--  end -->
		 </ul>
		 <!--  支付宝 -->
