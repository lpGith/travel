...
@section('content')
	...
	<div class="crumbs marginTop">
		<p><a href="http://www.travelzjj.com/">首页</a><span>&gt;</span><a href="{{URL('/goupiaolist')}}">优惠预订</a>
		<span>&gt;</span><a href="{{URL('/goupiaolist')}}">门票</a><span>&gt;</span><a href="javascript:void(0);" class="cur">天门山国家森林公园</a></p>  
	</div>
	...
	<div class="show-content clearfix">
		...
		<div class="show-topLBox">
			...
			<div class="show-focusWrap clearfix">
				<div id="play">
				  <ul class="img_ul">
				    <li style="display: list-item;"><a class="img_a"><img id="detail_mid" src="/uploads/{{$data->jiugoudetail_picname1}}" style="width: 535px;"></a></li>		    
				  </ul>  
				...
				<div class="img_hd" id="detail_did">
				  <ul class=" clearfix" style="height: 600px;">
				    ...
				    <li><a class="img_a"><img src="/uploads/{{$data->jiugoudetail_picname1}}"></a></li>
				    <li><a class="img_a"><img src="/uploads/{{$data->jiugoudetail_picname2}}"></a></li>
		...
		<div class="show-topRBox">
			<div class="ticket-rBox">
				<h2>{{$list->jiugou_name}}</h2>
				<span class="dengji"><i>{{$list->jiugou_pingji}}</i> 酒店</span>
				<p class="ticket-topInfo"><strong>酒店地址：</strong>{{$list->jiugou_address}}</p>				
				<a class="ticket-ydBtn">¥{{$list->jiugou_price1}}<b>/起</b></a>
			</div>
		</div>
 	...
 	<div class="ticket-contentInfoWrap">
 		...
 		<div class="ticket-tableWrap">
 			...
 			<table id="ticket-tablesId">
 				...
 				<tbody>
  					<tr>
 						<td class="tableInfo_txt" title="点击查看详情" rel="1">{{$list->jiugou_piaozhong}}</td>
 						<td>{{$data->jiugoudetail_zaocan}}</td>
 						<td>{{$data->jiugoudetail_kuandai}}</td>
 						<td class="table_sale">{{$data->jiugoudetail_zhengce}}</td>
 						<td>¥{{$list->jiugou_price1}}</td>
 						<td><a href="/goupiaopayhotel?id={{$list->id}}">预订</a></td>
 					</tr>
		...
		<div class="ticket-moreWrapBox">
			<div class="ticket-moreBtns" id="ticket-Btns" style="position: static; top: 784px; border-bottom-style: none;">
				<a href="javascript:;" title="" class="addCur">酒店介绍</a>
				<a href="javascript:;" title="" class="">酒店设施</a>
