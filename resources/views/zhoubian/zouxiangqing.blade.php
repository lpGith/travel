...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body style="background:url('/images/123456789.jpg') no-repeat;background-color:#1d1d11">
    ...
    <div class="wrapper" style="background-color:#ddd; padding-left:8px;padding-right:8px">
      <p>当前位置:<a href="/zhoubian/zoulist/">&nbsp;出行指南</a>&nbsp;>&nbsp;{{ $list[0]->zou_name }} &nbsp;>&nbsp;&nbsp;>&nbsp;<span style="font-size:15px;display:bload;float:right;margin-top:8px">发布日期:{{ date("Y年m月d日",$list[0]->zou_addtime) }}</span></p>
      <hr>
        <div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a title="分享到QQ空间" href="#" class="bds_qzone" data-cmd="qzone"></a><a title="分享到新浪微博" href="#" class="bds_tsina" data-cmd="tsina"></a><a title="分享到腾讯微博" href="#" class="bds_tqq" data-cmd="tqq"></a><a title="分享到人人网" href="#" class="bds_renren" data-cmd="renren"></a><a title="分享到微信" href="#" class="bds_weixin" data-cmd="weixin"></a></div>
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
      <h2 class="sub" style="display:blode;width:300px;height:60px;float:left">{{ $list[0]->zou_name }}</h2>
      <section class="container clearfix">   
        ...
        <div class="row" style="width:100%">
          <div class="left-col" style="width:100%">
            <img class="he_border2_img" src="/admin_zhoubian/{{ $list[0]->zou_picname }}" alt="Image 01">
            <p style="text-indent:2em">{!! $list[0]->zou_content !!}</p>
          </div>
            ...
            layer.prompt({ formType: 2}, function(text){
                $ .ajax({
                    ...
                    success:function(data){
                        var comment = $('#abc');
                        comment.load('/zhoubian/zouxiangqing/{{ $list[0]->id }} #abc');
