  ...
  <ol class="carousel-indicators">
    ...
    <!-- Wrapper for slides -->
        <div class="carousel-inner" role="listbox">
            ...
            <img src="/admin_zhoubian/qqqq2.jpg" alt="121321312">
            <div class="carousel-caption"style="margin-bottom:10px">
                <span style='font:25px/1 微软雅黑'>张家界半边国际酒店</span>
            </div>
            </div>
            @foreach($lunbo as $lb)

                    <div class="item">
                        <img src="/admin_zhoubian/{{$lb->picname}}" alt="阿萨飒飒">
                        <div class="carousel-caption" style="margin-bottom:10px">
                            <span style='font:25px/1 微软雅黑'>{{ $lb->name }}</span>
                        </div>
                    </div>
...
<div style="width:30%;height:50px;margin-top:28px;">
    <ul style="display-list:none">
        <li style="float:left;margin-left:40px"><a href="/zhoubian/zhulist" style="font:20px/50px 微软雅黑">全部</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/zhulists" style="font:20px/50px 微软雅黑">最新加盟</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/zhulistd" style="font:20px/50px 微软雅黑">最受关注</a></li>
    </ul>
</div>
		...
		<div class="col-md-9" style="height:300px;border-radius:8px; border:5px solid #ddd;float:right">
            ...
            <div class="box" style="margin:22px;float:left">
                <div class="he_border2 col-md-6"> 
                    <a href="/zhoubian/zhuxiangqing/{{ $zhu->id }}"><img class="he_border2_img" src="/admin_zhoubian/{{ $zhu->zhu_picname }}" alt="Image 01"></a>
                    <div class="he_border2_caption">
                    <h3 class="he_border2_caption_h" style="font: 2em 微软雅黑;">{{ $zhu->zhu_name }}</h3>
                    <p class="he_border2_caption_p" style="color:#cccc00;">{{ $zhu->zhu_location }}</p>
                    <a class="he_border2_caption_a" href="/zhoubian/zhuxiangqing/{{ $zhu->id }}"></a> </div>
                </div>
            </div>
            <div class="col-md-6"style="margin:20px">
                
                <p>
                    <span class="text-danger" style="font:1.5em 微软雅黑;">{{ $zhu->zhu_name }}</span>
                </p>
                
                <dl>
                    <dt>
                        <span class="glyphicon glyphicon-phone-alt" aria-hidden="true">订房热线:</span><span style="font:1em/3 微软雅黑;color:red">{{ $zhu->zhu_phone }}</span>    
                    </dt>
                    <dt>
                        <span class="glyphicon glyphicon-jpy" aria-hidden="true"></span>价格:</span><span style="font:1em/3 微软雅黑;color:red">{{ $zhu->zhu_type }}起</span>   
                    </dt>
                    <dt>
                        <span style="font:1em/3 微软雅黑;" title="{{ $zhu->zhu_describe }}">{{ mb_substr($zhu->zhu_describe,0,60) }}...</span>   
                    </dt>
                </dl>
                <p>
