...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <body style="background:url('/images/123456789.jpg') no-repeat;background-color:#1d1d11">
    ...
    <div class="wrapper" style="background-color:#ddd; padding-left:8px;padding-right:8px">
      <p>当前位置:<a href="/zhoubian/mailist/">特产推荐</a>>{{ $list[0]->mai_name }}<span style="font-size:15px;display:bload;float:right;margin-top:8px">发布日期:{{ date("Y年m月d日",$list[0]->mai_addtime) }}</span></p>
      <hr>
      <h2 class="sub" style="display:blode;width:400px;height:60px;float:left">{{ $list[0]->mai_name }}</h2>
      <section class="container clearfix"> 
        ...
        <div class="row">
          <div class="left-col">
            <img class="he_border2_img" src="/admin_zhoubian/{{ $list[0]->mai_picname }}" alt="Image 01" style="width:400px">
            <p style="text-indent:2em">{{ $list[0]->mai_describe }}</p>
          </div>
          <div class="right-col">
          <p style="font-size:15px">此特产被{{ $list[0]->mai_dianji }}次查看</p>
            <div style="height: 282px;" class="pin-wrapper"><div style="width: 290px; left: 882.5px; top: 0px; position: fixed;" class="pinned note-container">
              <div class="note">
                <p>{{ $list[0]->mai_name }}</p>
                <img class="he_border2_img" src="/admin_zhoubian/{{ $list[0]->mai_picname }}" alt="Image 01" style="width:50px">
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
      ...
      <section class="gallery">
        ...
        <div class="container clearfix">
          <div class="row">
            <div class="left-col">
              <div style="height: 128px;" class="pin-wrapper"><ul style="width: 168px;" class="nav pinned">
                <li><a href="#link-one">特产介绍</a></li>
                <li><a href="#link-two">特产甄别</a></li>
            ...
            layer.prompt({ formType: 2}, function(text){
                $ .ajax({
                    ...
                    success:function(data){
                        var comment = $('#abc');
                        comment.load('/zhoubian/maixiangqing/{{ $list[0]->id }} #abc');
