...
<div class="onlineService" style="z-index:99">
	<p class="ico_os"></p>
    <a class="ico_pp" onclick="FeedbackUtil.feed('#/');" href="javascript:void(0);" title=""></a>
    <a class="ico_gt" href="#" target="_self" title=""></a>
</div>
...
<div style="width:30%;height:50px;margin-top:28px;">
    <ul style="display-list:none">
        <li style="float:left;margin-left:40px"><a href="/zhoubian/chilist" style="font:20px/50px 微软雅黑">全部</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/chilists" style="font:20px/50px 微软雅黑">最新加盟</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/chilistd" style="font:20px/50px 微软雅黑">最受关注</a></li>
    </ul>
</div>
		...
		<div class="col-md-9" style="height:300px;border-radius:8px; border:5px solid #ddd;float:right">
            ...
            <div class="box" style="margin:22px;float:left">
                <div class="he_border2 col-md-6"> 
                    <img class="he_border2_img" src="/admin_zhoubian/{{ $chi->chi_picname }}" alt="Image 01">
                    <div class="he_border2_caption">
                    <h3 class="he_border2_caption_h" style="font: 2em 微软雅黑;">{{ $chi->chi_name }}</h3>
                    <p class="he_border2_caption_p" style="color:#cccc00;">{{ $chi->chi_location }}</p>
                    <a class="he_border2_caption_a" href="/zhoubian/chixiangqing/{{ $chi->id }}"></a> </div>
                </div>
            </div>
            <div class="col-md-6"style="margin:20px">
                
                <p>
                    <span class="text-danger" style="font:1.5em 微软雅黑;">{{ $chi->chi_name }}</span>
                </p>
                
                <dl>
                    <dt>
                        <span class="glyphicon glyphicon-phone-alt" aria-hidden="true">电话订餐:</span><span style="font:1em/3 微软雅黑;color:red">{{ $chi->chi_phone }}</span>    
                    </dt>
                    <dt>
                        </span>营业时间:</span><span style="font:1em/3 微软雅黑;color:red">{{ $chi->chi_time }}</span>   
                    </dt>
                    <dt>
                        <span style="font:1em/3 微软雅黑;" title="{{ $chi->chi_describe }}">{{ mb_substr($chi->chi_describe,0,60) }}...</span>   
                    </dt>
