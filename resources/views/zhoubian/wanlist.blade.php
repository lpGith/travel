...
<div style="width:30%;height:50px;margin-top:28px;">
    <ul style="display-list:none">
        <li style="float:left;margin-left:40px"><a href="/zhoubian/wanlist" style="font:20px/50px 微软雅黑">全部</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/wanlists" style="font:20px/50px 微软雅黑">最新活动</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/wanlistd" style="font:20px/50px 微软雅黑">热门活动</a></li>
    </ul>
</div>
		...
		<div class="col-md-9" style="height:300px;border-radius:8px; border:5px solid #ddd;float:right">
            ...
            <div class="box" style="margin:22px;float:left">
                <div class="he_border2 col-md-6"> 
                    <img class="he_border2_img" src="/admin_zhoubian/{{ $wan->wan_picname }}" alt="Image 01">
                    <div class="he_border2_caption">
                    <h3 class="he_border2_caption_h" style="font: 2em 微软雅黑;">{{ $wan->wan_name }}</h3>
                    <p class="he_border2_caption_p" style="color:#cccc00;">{{ $wan->wan_location }}</p>
                    <a class="he_border2_caption_a" href="/zhoubian/wanxiangqing/{{ $wan->id }}"></a> </div>
                </div>
            </div>
            <div class="col-md-6"style="margin:20px">
                
                <p>
                    <span class="text-danger" style="font:1.5em 微软雅黑;">{{ $wan->wan_name }}</span>
                </p>
                
                <dl>
                    <dt>
                        活动时间:</span><span style="font:1em/3 微软雅黑;color:red">{{ $wan->wan_time }}</span>    
                    </dt>
                    <dt>
                        </span>门票:</span><span style="font:1em/3 微软雅黑;color:red">{{ $wan->wan_price }}起</span>   
                    </dt>
                    <dt>
                        <span style="font:1em/3 微软雅黑;" title="{{ $wan->wan_describe }}">{{ mb_substr($wan->wan_describe,0,60) }}...</span>   
                    </dt>
