...
<div style="width:30%;height:50px;margin-top:28px;">
    <ul style="display-list:none">
        <li style="float:left;margin-left:40px"><a href="/zhoubian/mailist" style="font:20px/50px 微软雅黑">全部</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/mailists" style="font:20px/50px 微软雅黑">景区推荐</a></li>
        <li style="float:left;margin-left:40px"><a href="/zhoubian/mailistd" style="font:20px/50px 微软雅黑">热门特产</a></li>
    </ul>
</div>
		...
		<div class="col-md-9" style="height:300px;border-radius:8px; border:5px solid #ddd;float:right">
            ...
            <div class="box" style="margin:22px;float:left">
                <div class="he_border2 col-md-6"> 
                    <img class="he_border2_img" src="/admin_zhoubian/{{ $mai->mai_picname }}" alt="Image 01">
                    <div class="he_border2_caption">
                        <h3 class="he_border2_caption_h" style="font: 2em 微软雅黑;">{{ $mai->mai_name }}</h3>
                        <a class="he_border2_caption_a" href="/zhoubian/maixiangqing/{{ $mai->id }}"></a> 
                    </div>
                </div>
            </div>
            <div class="col-md-6"style="margin:20px">
                ...
                <p>
                    <span class="text-danger" style="font:1.5em 微软雅黑;">{{ $mai->mai_name }}</span>
                </p>
                
                <dl>
                    <dt>
                        <span style="font:1em/3 微软雅黑;" title="{{ $mai->mai_describe }}">{{ mb_substr($mai->mai_describe,0,60) }}...</span>   
                    </dt>
