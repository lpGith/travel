          ...
          <div class="row">
            ...
            <form action="insert" method="post" enctype="multipart/form-data">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <tr>
                    <td align="right">所属路线:</td>
                    <td>
                        <select name="you_typeid">
                            @foreach ($list as $aaa)
                            <option value="{{$aaa->id}}">{{$aaa->you_typename}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="you_name"/></td>
                </tr>
                <tr>
                    <td align="right">门票:</td>
                    <td><input type="text" name="you_price"/></td>
                </tr>
                <tr>
