        ...
        <section class="content">
          <div class="row">
            ...
            <table border="0" class="table table-bordered table-hover" style="width:80%">
                <form action="/admin/zhoubian/lb/update/{{ $avo->id }}" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 
                    <tr>
                        <td align="right"style="width:150px">图片信息</td>
                        <td><input type="text" name="name" value="{{ $avo->name }}" style="width:180px"/></td>
                    </tr>
                    <tr>
                        <td align="right">链接地址：</td>
                        <td><input name="path"value="{{ $avo->path }}"></td>
                    </tr>
                    <tr>
