            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-th"></i> 景区信息管理</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                 <form action="{{asset('admin/jingqu')}}" method="get" class="form-inline">
                ...
                <input type="submit" class="btn btn-primary" value="搜索"/>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <a href='{{asset("admin/jingqu")}}/{{ $data->id }}/edit'><button class="btn btn-xs btn-primary">编辑</button></a></td>                    
                    </tr>
                    @endforeach
                  </table>
          ...
          function doDel(id){
            Modal.confirm({msg:"是否删除信息?"}).on(function(e){
              if(e){
                ...
                form.action = "{{URL('./admin/jingqu')}}/"+id;
                form.submit();
              }
            })
          }
