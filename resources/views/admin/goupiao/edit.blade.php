          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
				 <form class="form-horizontal" action="/admin/goupiao/{{ $xx->id }}" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="_method" value="put">
						  <div class="box-body">
							<div class="form-group">
							  ...
							  <div class="col-sm-4">
								<input type="text" name="goupiao_model" value="{{$xx->goupiao_model}}" class="form-control" id="inputEmail3" placeholder="购票项目">
							  </div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-4">
								<input type="text" name="goupiao_url" value="{{$xx->goupiao_url}}" class="form-control" id="inputPassword3" placeholder="广告链接地址">
							  </div>
							</div>				
						  </div><!-- /.box-body -->
