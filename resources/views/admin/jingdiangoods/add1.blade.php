          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
				...
				<form class="form-horizontal" action="{{URL('/admin/jingdiantype11')}}" method="get" >
				
				<input type="hidden" name="pid" value="{{$xx->id}}">
				<input type="hidden" name="path" value="{{$xx->path}}{{$xx->id}},">
                  <div class="box-body">
					<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">父别名：{{$xx->jingdian_name}}</label>
