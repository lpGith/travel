...
<!-- Content Header (Page header) -->
        ...
        <section class="content">
          <div class="row">
			...
			<form class="form-horizontal" action="{{URL('/admin/jingdiandetail')}}" method="post" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
					  ...
					  <div class="col-sm-4">                        
						<select name="jingdian_typeid" class="form-control" id="inputEmail3">
							...
							?>
							<option value="{{$yy->id}}" {{($yy->pid==0)?"disabled":""}}>{{$nbsp}}|---->{{$yy->jingdian_name}}</option>
							@endforeach
						</select>
					  </div>
					</div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="jingdian_tuming" class="form-control" id="inputPassword3" placeholder="图片描述">
                      </div>
                    </div>		
					<div class="form-group">
