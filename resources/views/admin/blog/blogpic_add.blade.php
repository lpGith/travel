            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
				  ...
				  <form action="/blogpic_doadd" method="post" class="form-inline" enctype="multipart/form-data">
				  <input type="hidden" name="_method" value="post">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<tr>
						<td align="right">图片标题:</td>
						<td><input type="text" name="pic_title" required></td>
					</tr>
					<tr>
						<td align="right">图片:</td>
						<td><input type="file" name="pic_path" required></td>
					</tr>
					<tr>
						<td align="right"></td>
						<td>
