...
@section('content')
	...
	<div class="container-content">
		...
		<div class="crumbs marginTop">
			<p><a href="/">首页</a><span>&gt;</span><a href="/bendiliebiao">新闻动态</a><span>&gt;</span><a href="/bendixiangqing/id/{{$list->id}}" class="cur">本地资讯</a></p>
		</div>
		<div style="margin-top:20px;"></div>
		<div class="news_list-wrap clearfix marginTop">
			<div class="news_show-lBox">
				<h1 class="news_show-title">{{ $list->xinwen_name}}</h1>
				<p class="news_show-ftitle">{{ date('y-m-d',$list->xinwen_addtime)}}  |  来源：{{$list->xinwen_address}}</p>
